...
function check() {
  if (
    ...
    (r1c3.innerHTML === "X" &&
      r2c2.innerHTML === "X" &&
      r3c1.innerHTML === "X") ||
    (r1c1.innerHTML === "X" && r2c2.innerHTML === "X" && r3c3.innerHTML === "X")
  ) {
    scoreP1++;
    ...
    (r1c3.innerHTML === "O" &&
      r2c2.innerHTML === "O" &&
      r3c1.innerHTML === "O") ||
    (r1c1.innerHTML === "O" && r2c2.innerHTML === "O" && r3c3.innerHTML === "O")
  ) {
    scoreP2++;
...
function nextRound() {
  if (
    (winner === "p1" && checkNext === 0) ||
    (winner === "p2" && checkNext === 0) ||
    (winner === "draw" && checkNext === 0)
  ) {
    r1c1.innerHTML = "+";
    r1c2.innerHTML = "+";
    r1c3.innerHTML = "+";
